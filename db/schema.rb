...
ActiveRecord::Schema.define(version: 20170816041246) do
  ...
  add_index "attending_events", ["event_id"], name: "index_attending_events_on_event_id", using: :btree
  add_index "attending_events", ["user_id"], name: "index_attending_events_on_user_id", using: :btree
